...
class MediaGallery extends Component {
  ...
  renderFeaturedMedia() {
    const { editable, onMouseEnterMedia, onClickMedia, onMoveMedia, onRemoveMedia } = this.props;
  ...
  renderMediaThumbnails() {
    const { editable, media: mediaList, onMouseEnterMedia, onClickMedia, onMoveMedia, onRemoveMedia } = this.props;

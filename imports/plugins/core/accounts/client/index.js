...
export { default as ShipAddressBook } from "./components/shipAddressBook.js";
export { default as ShipAddressBookForm } from "./components/shipAddressBookForm";
export { default as ShipAddressBookGrid } from "./components/shipAddressBookGrid";
export { default as BillAddressBook } from "./components/billAddressBook.js";
export { default as BillAddressBookForm } from "./components/billAddressBookForm";
export { default as BillAddressBookGrid } from "./components/billAddressBookGrid";
...
export { default as StatusSingleOrder } from "./components/statusSingleOrder";
...
export { default as ShipAddressBookContainer } from "./containers/shipAddressBookContainer";
export { default as BillAddressBookContainer } from "./containers/billAddressBookContainer";
...
export { default as SingleOrderContainer } from "./containers/singleOrderContainer";
export { default as StatusSingleOrderContainer } from "./containers/statusSingleOrderContainer";
...
import "./templates/singleorder/singleorder.html";
import "./templates/singleorder/singleorder.js";

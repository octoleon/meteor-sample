...
class ShipAddressBookForm extends Component {
  static propTypes = {
    /**
     * add addess callback
     * @ignore
   ...
   * since a first address will always be the default shipping address.
   * @since 2.0.0
...
registerComponent("ShipAddressBookForm", ShipAddressBookForm);

export default ShipAddressBookForm;

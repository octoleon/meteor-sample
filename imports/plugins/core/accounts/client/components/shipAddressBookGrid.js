...
class ShipAddressBookGrid extends Component {
  static propTypes = {
    ...
    // selects a default shipping address
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // check to see if the new address is now the default shipping address
   ...
   * @summary updating the compoenet state with the new default shipping address.
   * @since 2.0.0
   ...
   * a default shipping address. This handler sets the default address
  ...
  renderAddressGrid() {
    ...
    return addressBook.map((address) => {
      const { defaultShippingAddressId } = this.state;
...
registerComponent("ShipAddressBookGrid", ShipAddressBookGrid);

export default ShipAddressBookGrid;

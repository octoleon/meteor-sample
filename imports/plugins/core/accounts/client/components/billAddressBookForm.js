...
class BillAddressBookForm extends Component {
  static propTypes = {
    /**
     * add addess callback
     * @ignore
   ...
   * since a first address will always be the default billing address.
   * @since 2.0.0
...
registerComponent("BillAddressBookForm", BillAddressBookForm);

export default BillAddressBookForm;

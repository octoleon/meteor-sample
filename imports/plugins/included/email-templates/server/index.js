...
/*
 * Orders - New Order Place
 * When: A user completes the cart checkout flow and a new order is sent to Admin with another template (not using normal template)
 */
Reaction.registerTemplate({
  title: "Orders - New Order Placed",
  name: TemplatePaths.coreOrderNewToAdmin,
  type: "email",
  template: Reaction.Email.getTemplateFile(TemplatePaths.coreOrderNewToAdmin),

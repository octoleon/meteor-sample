...
export default class ColorQuizContainer extends Component {
  ...
  handleColorQuiz21Click = () => {
    this.setState({ view: 'colorQuiz21' });
  };
  ...
  render () {
    ...
    return (
      <ColorQuiz
        ...
        onColorQuiz21Click={this.handleColorQuiz21Click}

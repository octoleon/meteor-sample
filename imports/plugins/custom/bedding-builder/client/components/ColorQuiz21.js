...
export default class ColorQuiz21 extends Component {
  ...
  render () {
    const { onHaveClick, onHelpClick, onUploadClick, onColorQuiz21Click } = this.props;
          ...
          <div className="div-block-39">
            <div className="div-block-9">
              <div className="div-block-17-no-tooltip">
                <h1 className="heading-3-no-tooltip-2">Hello quiz page 2</h1>
              </div>
              ...
              <div className="bedding-builder-holder">
                <div className="row-bedding w-row">
                  ...
                  <div className="bedding-builder-3-column w-col w-col-3 w-col-stack">
                    <div className="bedding-builder-containerblock" onClick={onColorQuiz21Click}> nice !
                    </div>
                  </div>

          ...
          <div>
            <div className="div-block-9coo">
              <div className="div-block-15">
                ...
                <div className="div-block-19">
                  <div className="text-block-115">Move the color circles around the image to find the perfect color. Click the heart symbol to add a color to your swatchbook.</div>
                </div>

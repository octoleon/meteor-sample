...
import { FlaneurCheckoutModal } from "/imports/plugins/custom/flaneur/client/components/FlaneurCheckoutModal"
...
const handlers = {
  ...
  */
  ...
  handleShowProduct(productItem, slug) {
    if (productItem) {
      var variantId = '';
    ...
    handleAddToCart = () => {
      ...
      if (currentVariant) {
        ...
        if (!currentProduct.isVisible) {
          ...
          // open cartdraw which is modal now

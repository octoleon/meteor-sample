/**
 * @file
 * Customized versoin of Reaction's core OrderFilter component.
 * Adds support for custom acknowledged and exception order statuses.
 */
...
import * as Constants from "/imports/plugins/core/orders/lib/constants";
import { customOrderStatuses } from '../../lib/constants';

// Customization - include custom order statuses in filter dropdown
const workflowStatuses = [...Constants.workflowStatus, ...customOrderStatuses];

class FlaneurOrderFilter extends Component {
  static propTypes = {
...
replaceComponent("OrderFilter", FlaneurOrderFilter);

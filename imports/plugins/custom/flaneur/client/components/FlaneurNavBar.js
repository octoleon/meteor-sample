...
class FlaneurNavBar extends Component {
  ...
  componentDidMount () {
    ...
    $(".trigger-estee-stanley-bohemian").mouseover(function(){
        $(".dropdown-menu-column.center-block.alt").removeClass("list-link-blank").addClass("list-link-estee-bohemian")
    });
    $(".trigger-estee-stanley-bohemian").mouseout(function(){
      $(".dropdown-menu-column.center-block.alt").removeClass("list-link-estee-bohemian").addClass("list-link-blank")

    });
    $(".trigger-estee-stanley-modern").mouseover(function(){
        $(".dropdown-menu-column.center-block.alt").removeClass("list-link-blank").addClass("list-link-estee-modern")
    });
    $(".trigger-estee-stanley-modern").mouseout(function(){
      $(".dropdown-menu-column.center-block.alt").removeClass("list-link-estee-modern").addClass("list-link-blank")
              ...
              <div className="tab-content">
                <div className="dropdown-menu-columns links-block">
                  <div className="dropdown-menu-column center-block">
                    ...
                    <li className="trigger-estee-stanley-bohemian"><a href="/product/estee-stanley-bohemian-look">Bohemian Look (Estee Stanley)</a></li>
                    <li className="trigger-estee-stanley"><a href="/product/estee-stanley-masculine-look">Grayscale Look (Estee Stanley)</a></li>
                    <li className="trigger-estee-stanley-modern"><a href="/product/estee-stanley-modern-look">Modern Look (Estee Stanley)</a></li>
                  </div>

      ...
      <Components.CardGroup>
        ...
        >
          ...
          <Components.CardBody expandable={true}>
            ...
            <div className="rui form-group">
              <label><span>Specs</span></label>
              <ContentEditor
                value={this.product.specs}
                onChange={(value) => this.handleFieldChange(null, value, 'specs')}
                onBlur={(value) => this.handleFieldBlur(null, this.product.specs, 'specs')}
              />
            </div>
            <div className="rui form-group">
            ...
            <div className="rui form-group">
              <label><span>Page Content Top</span></label>
              <ContentEditor
                value={this.product.pageContentTop}
                onChange={(value) => this.handleFieldChange(null, value, 'pageContentTop')}
                onBlur={(value) => this.handleFieldBlur(null, this.product.pageContentTop, 'pageContentTop')}
              />
            </div>
            <div className="rui form-group">
              <label><span>Share</span></label>
              <ContentEditor
                value={this.product.share}
                onChange={(value) => this.handleFieldChange(null, value, 'share')}
                onBlur={(value) => this.handleFieldBlur(null, this.product.share, 'share')}
              />
            </div>
            {isCapsule && (
              <Components.TextField
